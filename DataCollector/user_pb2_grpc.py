...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UserExists = channel.unary_unary(
                '/usermanager.UserService/UserExists',
...
class UserServiceServicer(object):
    ...
    def UserExists(self, request, context):
        """Il Data Collector chiede se un utente esiste
        """
...
def add_UserServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'usermanager.UserService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('usermanager.UserService', rpc_method_handlers)
